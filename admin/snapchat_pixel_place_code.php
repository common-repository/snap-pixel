...
$addtocart = (isset($snapchat_pixel_code['addtocart']) ? $snapchat_pixel_code['addtocart'] : '');
...
if(is_home() or is_front_page()){
...
} else if( $snapchat_pixel->snapchat_pixel_wooexist() ){
	if( $addtocart == 'checked' || is_shop() ){
		add_action ('wp_head', array($snapchat_pixel, 'snapchat_pixel_code_everywhere'), 2);
	...
	if($snapchat_pixel->snapchat_pixel_wooexist() && is_product()){
		if( $viewcart == 'checked' ){
